...
public class SOTabBar: UIView {
   ...
   internal var viewControllers = [UIViewController]() {
    ...
    private func didSelectTab(index: Int) {
        ...
        self.tabSelectedImageView.image = self.tabSelectedImageView.image?.withRenderingMode(.alwaysTemplate)
        self.tabSelectedImageView.tintColor = SOTabBarSetting.tabBarSelectedImageColor
    }
