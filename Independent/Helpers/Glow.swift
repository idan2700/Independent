...
extension UIView {
    ...
    func startGlowingWithColor(color:UIColor, intensity:CGFloat) {
        self.startGlowingWithColor(color: color, fromIntensity: 0.1, toIntensity: intensity, repeat: false)
    }
    ...
    func startGlowing() {
        self.startGlowingWithColor(color: UIColor(named: "gold")!, intensity:0.6);
    }
